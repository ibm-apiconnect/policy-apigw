...
The file `assembly-rate-limit-list.zip` is a  list of pre-onfigured limit objects to be applied to an API Collection. 

See here for more information about gateway extensions
